...
const ClassTransformVisitor = {
  ...
  Class: {
    enter(path, {
      ...
      const className = node === null || node === void 0 ? void 0 : (_node$id = node.id) === null || _node$id === void 0 ? void 0 : _node$id.name;
    ...
    exit(path, {
      ...
      const className = node === null || node === void 0 ? void 0 : (_node$id2 = node.id) === null || _node$id2 === void 0 ? void 0 : _node$id2.name;
